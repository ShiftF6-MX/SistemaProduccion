...
public class PantallaCentroTrabajo {
	...
	@FXML
	private TableView<CentroTrabajo> tablaCentroTrabajo;
	@FXML
	private PTableColumn<CentroTrabajo, String> columnaCodigo;
	@FXML
	private PTableColumn<CentroTrabajo, String> columnaDescripcion;
	@FXML
	private PTableColumn<CentroTrabajo, String> columnaGrupoTrabajo;
	@FXML 
	private PTableColumn<CentroTrabajo, String> columnaAcciones;
	//FIN CONPONENTES
	...
	private void inicializarTabla() {
		...
		this.columnaGrupoTrabajo.setCellValueFactory(CellData -> CellData.getValue().getGrupoTrabajo(this.connection).codigoProperty());
		actualizarTabla();
	...
	public void actualizarTabla() {
		...
		this.listaCentroTrabajo = CentroTrabajoDAO.readCentroTrabajo(mainApp.getConnection());
		this.tablaCentroTrabajo.setItems(FXCollections.observableArrayList(listaCentroTrabajo));
	...
	private void buscarRegistro() {
		...
		listaCentroTrabajo = CentroTrabajoDAO.readCentroTrabajo(connection);
				...
				public void updateItem(String item, boolean empty) {
					...
					//MANEJADORES PARA LOS BOTONES
							botonVer.setOnAction(event -> {
								...
								manejadorBotonVer(centroTrabajo);
							});//FIN MANEJADDOR
						
							botonEditar.setOnAction(event -> {
								centroTrabajo = getTableView().getItems().get(getIndex());
								manejadorBotonEditar(centroTrabajo);
						});//FIN MANEJADDOR
						
						botonEliminar.setOnAction(event -> {
							centroTrabajo = getTableView().getItems().get(getIndex());
							 manejadorBotonEliminar(centroTrabajo);
						});//FIN MANEJADDOR
	...
	//MANEJADORES COMPONENTES
		...
		private void manejadorBotonVer(CentroTrabajo centroTrabajo) {
		//	this.mainApp.iniciarDialogoAcabado(empleado, DialogoAcabado.VER);
			this.actualizarTabla();
		}//FIN METODO
		
		private void manejadorBotonEditar(CentroTrabajo centroTrabajo) {
		//	this.mainApp.iniciarDialogoAcabado(empleado, DialogoAcabado.EDITAR);
			this.actualizarTabla();
		}//FIN METODO
		
		private void manejadorBotonEliminar(CentroTrabajo centroTrabajo) {
