...
public class DialogoAgregarAcabado {
	...
	public void setMainApp(MainApp mainApp, Acabado acabado, int opcion) {
	...
	private void inicializarComponentes() {		
		if (this.opcion == CREAR) {
			...
			this.campoTextoCodigo.setText(this.acabado.getCodigo());
			this.campoTextoCodigo.setDisable(true);
			this.campoTextoDescripcion.setText(this.acabado.getDescripcion());
			this.campoTextoDescripcion.setDisable(true);
			this.comboBoxStatus.getSelectionModel().select(this.acabado.getStatus());
	...
	@FXML private void vmanejadorBotonAceptar() {
		if (this.validarDatos()) {
			if (this.opcion == CREAR) {
				this.acabado.setCodigo(this.campoTextoCodigo.getText());
				this.acabado.setDescripcion(this.campoTextoDescripcion.getText());
				this.acabado.setStatus(Status.toInt(this.comboBoxStatus.getSelectionModel().getSelectedItem()));
				if (AcabadoDAO.createAcabado(this.mainApp.getConnection(), this.acabado)) {
				...
				this.acabado.setDescripcion(this.campoTextoDescripcion.getText());
				this.acabado.setStatus(Status.toInt(this.comboBoxStatus.getSelectionModel().getSelectedItem()));
				if (AcabadoDAO.updateAcabado(this.mainApp.getConnection(), this.acabado)) {
